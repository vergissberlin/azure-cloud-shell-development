...
| `APIGEE_OVERRIDE_TLS_CERT_REL` | `sslCertPath` in `overrides.yaml`, relative to the `apigee-virtualhost` chart (e.g. `certs/tls.crt`).                                                                                                                                                |
| `APIGEE_OVERRIDE_TLS_KEY_REL` | `sslKeyPath` relative to the `apigee-virtualhost` chart (e.g. `certs/tls.key`).                                                                                                                                                                        |
